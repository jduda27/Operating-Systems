/**
 * Operating Systems Project 1 A stack class that can be accessed by other
 * classes securely that can use 0x3FF memory space.
 * 
 * @Author Joshua Duda
 * @Date 2/5/2020
 */
public class Stack {
	...
	// Here we have a constructor that initializes our stack to the default
	// parameters
	public Stack() {
	 ...
	 * 
	 * @preconditions String item - a valid string object that is being added to the
	 *                stack.
	 * @postconditions If the stack is not full we put the inputed item into the
	 *                 stack.
	 */
	 ...
	 * 
	 * @preconditions none.
	 * @postconditions If the stack is not empty we return the string item that is
	 *                 being stored at the top and remove it.
	 */
	public String pop() {
		if (!isEmpty()) {
