...
*   securly by other classes.
*   @Author Joshua Duda
*   @Date 2/5/2020
*/
public class Memory {

	//initiating the private varables that will be stored
	private int mem3AE;
	private int mem3AD;
	private int mem3AC;
	...
	*/
	 ...
	 * @postcondition: The method sets the hex to the correct memory location or if invalid it
	 * 		   lets the user know it is not a valid memory location.
	 */
	public void memSet(String memLoc, int val) {
		// checking for our three dsignated memory locations in decimal and using the setter 
